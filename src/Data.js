...
export const skillList = [
 ...
 export const Bio = {
   Name:'G Venkata Narendra',
   Bio:'Experienced developer with 2+ years of expertise in Node.js, React.js, and MongoDB. Known for building scalable web apps and fixing bugs with ease. Committed to delivering top-quality code and always learning.',
   Email:'dev.gvnarendra@gmail.com'
 }